...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_USR_COUNT,
            query = JpaConst.Q_USR_COUNT_DEF),
    @NamedQuery(
            name = JpaConst.Q_USR_COUNT_REGISTERED_BY_CODE,
            query = JpaConst.Q_USR_COUNT_REGISTERED_BY_CODE_DEF),
    @NamedQuery(
...
public class User {
     ...
     * ユーザー番号
     */
    @Column(name = JpaConst.USR_COL_CODE, nullable = false, unique = true)
    private String code;
